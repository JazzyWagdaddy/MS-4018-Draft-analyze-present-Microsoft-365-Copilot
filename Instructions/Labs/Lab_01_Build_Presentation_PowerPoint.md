...
1. Click on the appropriate **Copilot** icon and select , click **Chat** if you are using the desktop application, and then within the Copilot chat window enter the following prompt:
